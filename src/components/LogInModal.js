...
const LogInModal = ({ isOpen, onClose, onOpen }) => {
  ...
  const onLogin = async (data) => {
    ...
    try {
      const response = await callApi("https://5a45-2601-647-4b80-78a0-c065-8375-c08-9e97.ngrok-free.app/api/user/info/login", "PUT", {
        email: data.email,
  ...
  const onSignUp = async (data) => {
    ...
    try {
      const response = await callApi("https://5a45-2601-647-4b80-78a0-c065-8375-c08-9e97.ngrok-free.app/api/user/info/save", "POST", {
        email: data.email,
        password: data.password,
        type: data.userType,
      });
